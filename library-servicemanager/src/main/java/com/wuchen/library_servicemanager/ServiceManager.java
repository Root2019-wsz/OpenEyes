...
import com.wuchen.library_servicemanager.compat.ContentProviderCompat;
...
public class ServiceManager {
    ...
    public static void init(Application application) {
        ...
        //为每个进程发布一个binder
        BundleCompat.putBinder(argsBundle, ServiceProvider.BINDER, new com.wuchen.library_servicemanager.ProcessBinder(com.wuchen.library_servicemanager.ProcessBinder.class.getName() + "_" + pid));
