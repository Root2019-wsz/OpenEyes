package com.wuchen.library_servicemanager;
...
import com.wuchen.library_servicemanager.compat.BundleCompat;
import com.wuchen.library_servicemanager.local.ServicePool;
...
public class ServiceProvider extends ContentProvider {
    ...
    public static Uri buildUri() {
        if (CONTENT_URI == null) {
            CONTENT_URI = Uri.parse("content://"+ com.wuchen.library_servicemanager.ServiceManager.sApplication.getPackageName() + ".svcmgr/call");
        }
        return CONTENT_URI;
    }
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        ...
        if (method.equals(REPORT_BINDER)) {
            ...
            return com.wuchen.library_servicemanager.MethodRouter.routerToInstance(extras);
                ...
                if (instance != null && !Proxy.isProxyClass(instance.getClass())) {
                    ...
                    if (recorder != null) {
                        ...
                        if (iBinder != null && iBinder.isBinderAlive()) {
                            ...
                            bundle.putString(QUERY_SERVICE_RESULT_DESCRIPTOR, com.wuchen.library_servicemanager.ProcessBinder.class.getName() + "_" + recorder.pid);
    ...
    private void notifyClient(String name) {
        //通知持有服务的客户端清理缓存
        Intent intent = new Intent(com.wuchen.library_servicemanager.ServiceManager.ACTION_SERVICE_DIE_OR_CLEAR);
        intent.putExtra(NAME, name);
        com.wuchen.library_servicemanager.ServiceManager.sApplication.sendBroadcast(intent);
    }
