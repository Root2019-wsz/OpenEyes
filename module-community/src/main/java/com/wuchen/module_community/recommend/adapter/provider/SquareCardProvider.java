...
import com.wuchen.module_community.databinding.CommunityItemSquareCardViewBinding;
import com.wuchen.module_community.R;
import com.wuchen.module_community.recommend.adapter.SquareCardAdapter;
...
public class SquareCardProvider extends BaseItemProvider<BaseCustomViewModel> {
    ...
    public void onViewHolderCreated(@NotNull BaseViewHolder viewHolder, int viewType) {
        @SuppressLint("ResourceType") CommunityItemSquareCardViewBinding binding = DataBindingUtil.bind(viewHolder.getView(R.layout.community_item_square_item_card_view));
        StaggeredGridLayoutManager.LayoutParams layoutParams =
                new StaggeredGridLayoutManager.LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT,
                        DensityUtils.dp2px(getContext(),80));
        layoutParams.setFullSpan(true);
        viewHolder.getView(R.layout.community_item_square_item_card_view).setLayoutParams(layoutParams);
